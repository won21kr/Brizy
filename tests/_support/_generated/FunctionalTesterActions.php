<?php  //[STAMP] a56dc0e31c60efdd71884d411de90b54
...
trait FunctionalTesterActions
{
     ...
     *
     *
     * @see \Helper\Functional::haveManyFontsInDataBase()
     */
    public function haveManyFontsInDataBase($count, $fontFamily, $weights, $type, $status = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveManyFontsInDataBase', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Integration::makeTemporaryFile()
     */
    public function makeTemporaryFile($sourcePath) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('makeTemporaryFile', func_get_args()));
    }
	 ...
	 *
	 * @return string
     * @see \Helper\Functional::ajaxUrl()
     */
    public function ajaxUrl($action, $params = null, $prefix = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('ajaxUrl', func_get_args()));
    }
     ...
     * @see \Helper\Functional::grabJsonResponse()
     */
    public function grabJsonResponse($I) {
     ...
     *
     *
     * @see \Helper\Functional::canSeePostContentContainsString()
     */
    public function canSeePostContentContainsString($postid, $string) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('canSeePostContentContainsString', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Functional::canSeePostInDatabaseContainingContent()
     */
    public function canSeePostInDatabaseContainingContent($postId, $content) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('canSeePostInDatabaseContainingContent', func_get_args()));
    }
